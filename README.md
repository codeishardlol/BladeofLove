...
**Blade of Love** 是一款 PC 横版编队自动战斗肉鸽游戏。选择角色、安排 3×2 阵型、搭配装备与祝福，再沿大地图探索战斗、商人和旅途事件。决定胜负的不只有一次技能的伤害，也有元素附着的顺序、队伍的行动节奏，以及谁掌握了战场主动权。
...
## 当前进度与公开范围
![剧情对话界面](docs/showcase/baowu.png)
![剧情对话界面](docs/showcase/sale.png)
![剧情对话界面](docs/showcase/gacha.png)
24 章主线、3 段战败幕、2 段重来幕，约10万字、232 段对白，全部 30 位角色。构筑目录包含 31 种祝福，其中 21 种带有机制效果；旅途事件与两张地图持续扩充中。

## 反馈说明

欢迎通过 [GitHub Issues](https://github.com/codeishardlol/BladeofLove/issues) 反馈体验建议、构筑想法和希望看到的机制。
体验demo请联系fromzy@163.com
